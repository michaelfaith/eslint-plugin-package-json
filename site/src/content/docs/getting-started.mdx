...
<Aside type="tip">
  ...
  guide](https://eslint.org/docs/latest/use/configure/configuration-files) for details on how to
  customize your rules and other config settings.
</Aside>
...
<Aside type="caution">
  All exports from the `/experimental` entry point are considered unstable and may change in
  breaking ways in minor version releases.
</Aside>
