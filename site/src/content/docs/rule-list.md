...
| [no-local-dependencies](/rules/no-local-dependencies)                                     | Requires that dependencies do not use local file paths, which will cause errors when installing from a registry.                                                                             |      |    |    |
