...
| [compatible-engines](https://eslint-plugin-package-json.dev/rules/compatible-engines)                                           | Ensures that the engines for all dependencies are compatible with the package's engines.                                                                                                     |     |     |     |
