...
| [require-package-json-export](https://eslint-plugin-package-json.dev/rules/require-package-json-export)                         | Ensures that if a package specifies `exports` (or `publishConfig.exports`), an explicit `package.json` export is included.                                                                   |     |     | 💡  |
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/thernstig"><img src="https://avatars.githubusercontent.com/u/30827238?v=4?s=100" width="100px;" alt="Tobias Hernstig"/><br /><sub><b>Tobias Hernstig</b></sub></a><br /><a href="https://github.com/michaelfaith/eslint-plugin-package-json/issues?q=author%3Athernstig" title="Bug reports">🐛</a></td>
