...
ruleTester.run('valid-peerDependenciesMeta', rules['valid-peerDependenciesMeta'], {
  invalid: [
    {
      code: `{
...
`,
      errors: [
        {
          data: {
            error: 'the value is `null`, but should be an object with peer dependency metadata',
          },
          line: 2,
      ...
      errors: [
        {
          column: 18,
          data: {
            error: 'the peer dependency metadata for `david` should be an object, not `string`',
          },
          line: 3,
          messageId: 'validationError',
        },
        {
          column: 18,
          data: {
            error: 'the peer dependency metadata for `trent` should be an object, not `number`',
          },
          line: 4,
          messageId: 'validationError',
        },
        {
          column: 24,
          data: {
            error: 'the peer dependency metadata for `the-fragile` should be an object, not `null`',
          },
          line: 5,
          messageId: 'validationError',
        },
        {
          column: 23,
          data: {
            error: 'the peer dependency metadata for `pink-floyd` should be an object, not `Array`',
          },
          line: 6,
          messageId: 'validationError',
        },
...
`,
      errors: [
        ...
        },
        {
          column: 15,
          data: {
            error: 'unexpected property ``; only `optional` is allowed in peer dependency metadata',
          },
          line: 12,
          messageId: 'validationError',
        },
