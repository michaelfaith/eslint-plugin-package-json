...
|                                               | ContainerNode      | Any node that represents the container for a JSON value.                                                                                                                                       |
| (`DocumentNode \| MemberNode \| ElementNode`) |
...
| JSONIdentifier                                | IdentifierNode     | Abstraction for other\*Indentifer types                                                                                                                                                        |
